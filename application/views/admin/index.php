              ...
              <div class="templatemo-content-widget orange-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-circle" src="<?php echo $resource;?>images/sunset.jpg" alt="Sunset">
                    </a>
                  </div>
    ...
    <!-- JS -->
    <script src="<?php echo $resource;?>js/jquery-1.11.2.min.js"></script>      <!-- jQuery -->
    <script src="<?php echo $resource;?>js/jquery-migrate-1.2.1.min.js"></script> <!--  jQuery Migrate Plugin -->
    ...
    <script type="text/javascript" src="<?php echo $resource;?>js/templatemo-script.js"></script>      <!-- Templatemo Script -->
